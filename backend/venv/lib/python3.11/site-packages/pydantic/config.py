...
class ConfigDict(TypedDict, total=False):
    ...
    athlete = Athlete(firstName='Zack', lastName='', sport='track')
    print(athlete.model_dump(by_alias=True))
    #> {'FirstName': 'Zack', 'LastName': '', 'Sport': 'track'}
    ```
